...
class Booking extends BaseService
{
    ...
    public function insert($roomId, $userId, $checkInDate, $checkOutDate)
    {
        ...
        $this->execute('INSERT INTO booking (room_id, user_id, total_price, check_in_date, check_out_date) VALUES 
        (:room_id, :user_id, :total_price, :check_in_date, :check_out_date)', $parameters);
